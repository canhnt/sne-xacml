...
/**
 * AllOfExpression class is to parse the AllOf XACML 3.0 element, which returns 
 * the map of parsed intervals for each variable identifiers. 
 * 
 * Note: AllOf XACML3 element contains conjunctive sequence of Match expressions.
 * 
 *  AllOfType := SEQUENCE_OF<MatchExpression>
 *  MatchExpression := (operator, value, varId) // statement: <value> <op> <varId>
