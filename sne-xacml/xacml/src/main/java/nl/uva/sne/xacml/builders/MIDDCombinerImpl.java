 ...
 */
public class MIDDCombinerImpl implements MIDDCombiner {
    private static final Logger log = LoggerFactory.getLogger(MIDDCombinerImpl.class);
    ...
    @Inject
    public MIDDCombinerImpl(final XNodeFactory nodeFactory,
    ...
    public Node combine(Node midd1, Node midd2) throws MIDDException {
        ...
        if (midd1 instanceof ExternalNode3) {
            if (midd2 instanceof ExternalNode3) {
                ...
                InternalXACMLNode<?> n2 = (InternalXACMLNode<?>) midd2;
                return combineIDD(n1, n2); // combine an external node n1 with an internal node n2
            }
        } else {
            InternalXACMLNode<?> n1 = (InternalXACMLNode<?>) midd1;
            ...
            if (midd2 instanceof ExternalNode3) {
                ...
                if (n1.getID() == n2.getID()) {
                    ...
                    InternalXACMLNode<?> n = null;
                    if (n1.getID() < n2.getID()) {

                        // Clone n1
                        n = NodeUtils.createInternalNode(n1);
                        ...
                        n = NodeUtils.createInternalNode(n2);
    ...
    private Node combineIDD(ExternalNode3 n1, InternalXACMLNode<?> n2) throws MIDDException {
        ...
        InternalXACMLNode<?> n = nodeFactory.create(n2.getID(), newINState, n2.getType());
     ...
     */
    @SuppressWarnings("rawtypes")
    private Node combineIDD(InternalXACMLNode<?> n1,
        ...
        InternalXACMLNode<?> n = nodeFactory.create(n1.getID(), newINState, n1.getType());
    ...
    private InternalXACMLNode<?> combineIDDSameLevel(InternalXACMLNode n1,
                                                     InternalXACMLNode n2) throws MIDDException {
        if (n1.getID() != n2.getID()) {
        ...
        InternalXACMLNode<?> n = nodeFactory.create(n1.getID(), newState, n1.getType());
