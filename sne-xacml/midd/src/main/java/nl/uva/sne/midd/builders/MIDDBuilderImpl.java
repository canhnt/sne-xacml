 ...
 * @since 2016-04-10
 */
public class MIDDBuilderImpl implements MIDDBuilder {
    private static final Logger log = LoggerFactory.getLogger(MIDDBuilderImpl.class);
    ...
    @Override
    public Node and(Node midd1, Node midd2) throws MIDDException {
        ...
        if (midd1 instanceof ExternalNode) {
            ...
            if (midd2 instanceof ExternalNode) {
                ...
                if (n1.getID() == n2.getID()) {
                    return andMIDDsAtSameLevel(n1, n2);
                } else {
                    ...
                    for (AbstractEdge<?> e : n1.getEdges()) {
                        Node child = and(e.getSubDiagram(), n2);
                        if (child != null) {
    ...
    @Override
    public Node or(Node midd1, Node midd2) throws MIDDException {
        if (midd1 == null || midd2 == null) {
        ...
        if (midd1 instanceof ExternalNode ||
            ...
            if (n1.getID() == n2.getID()) {
                return orMIDDsAtSameLevel(n1, n2);
            } else {
                //n1 as lower variable order than n2, so:
                // - Create a node clone from n1 -> n
                // - combine n2 with all children of n1 -> children[1..k], add them to children of n
                ...
                for (AbstractEdge<?> e : n1.getEdges()) {
                    Node child = or(e.getSubDiagram(), n2);
                    if (child != null) {
                        n.addChild(EdgeUtils.cloneEdge(e), child);
                    } else {
    ...
    private InternalNode<?> andMIDDsAtSameLevel(InternalNode n1, InternalNode n2) throws MIDDException {
        if (n1.getID() != n2.getID()) {
    ...
    private InternalNode<?> orMIDDsAtSameLevel(InternalNode n1,
