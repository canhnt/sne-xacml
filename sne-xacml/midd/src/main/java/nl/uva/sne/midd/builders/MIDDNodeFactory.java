...
public class MIDDNodeFactory implements NodeFactory {

    @Override
    public InternalNode create(final InternalNode source) throws MIDDException {
        return new InternalNodeImpl<>(source);
    }
}
